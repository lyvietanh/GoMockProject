...
func NewCustomerApiHandler(userGrpcClient pb.UserGrpcClient) CustomerApiHandler {
	return CustomerApiHandler{
		UserGrpcClient: userGrpcClient,
	}
}

func (h *CustomerApiHandler) VerifyRolePermission(ctx *gin.Context, roleIds *[]string) (*pb.GrpcVerifyAuthResponse, error) {
